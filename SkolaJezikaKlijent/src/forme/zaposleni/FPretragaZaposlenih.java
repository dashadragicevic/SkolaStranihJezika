...
import forme.zaposleni.ki.KontrolorKIPretraziZaposlene;
import forme.zaposleni.ki.KontrolorKIPronadjiZaposlenog;
...
public class FPretragaZaposlenih extends javax.swing.JFrame {
    ...
    private void jbtnPronadjiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnPronadjiActionPerformed
        ...
        KontrolorKIPretraziZaposlene.pretraziZaposlene(jtxtIme, jtxtPrezime, jtxtJMBG, jtblZaposleni);
    ...
    private void jbtnDetaljiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnDetaljiActionPerformed
        // TODO add your handling code here:
        int i = jtblZaposleni.getSelectedRow();
        if(i==-1){
            JOptionPane.showMessageDialog(this, "Niste odarali nijedanog zaposlenog sa spiska!", "Greska", JOptionPane.ERROR_MESSAGE);
        } else {
            this.dispose();
            KontrolorKIPronadjiZaposlenog.pronadjiZaposlenog(jtblZaposleni);
        }
    ...
    private void popuniTabeluZaposleni() {
        List<Zaposleni> z = new ArrayList<>();
        ModelTabeleZaposleni m = new ModelTabeleZaposleni(z);
